...
INSERT INTO `supermarketten_bom` (`id`, `order_id`, `product_id`, `quantity`) VALUES
(1, 1, 11, 1),
(2, 2, 11, 1),
(3, 2, 9, 1);
...
INSERT INTO `supermarketten_order` (`id`, `sn`, `name`, `address`, `phone`, `status`, `urge`) VALUES
(1, '877cbf2d-d616-4c6e-a2e2-89dfcdc7e1f4', '陶佳元', '上海', '13402110752', 4, 1),
(2, '05772fe1-41cb-408a-8007-1a67d9aa1bf9', NULL, NULL, NULL, 0, 0);
